...
#orvtnzsduo .gt_column_spanner_outer:first-child {
  padding-left: 0;
}
...
#orvtnzsduo .gt_from_md > :first-child {
  margin-top: 0;
}
...
#orvtnzsduo .gt_grand_summary_row {
  color: #323232;
  background-color: #FFFFFF;
  text-transform: inherit;
  padding-top: 8px;
